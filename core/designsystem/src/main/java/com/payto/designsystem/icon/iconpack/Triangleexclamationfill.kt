...
public val IconPack.Triangleexclamationfill: ImageVector
    get() {
        if (_triangleexclamationfill != null) {
            return _triangleexclamationfill!!
        }
        _triangleexclamationfill = Builder(name = "Triangleexclamationfill", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF343942)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.101f, 9.0137f)
                horizontalLineTo(12.901f)
                verticalLineTo(15.0111f)
                horizontalLineTo(11.101f)
                verticalLineTo(9.0137f)
                close()
                moveTo(13.201f, 17.2101f)
                curveTo(13.201f, 17.8726f, 12.6638f, 18.4096f, 12.001f, 18.4096f)
                curveTo(11.3383f, 18.4096f, 10.801f, 17.8726f, 10.801f, 17.2101f)
                curveTo(10.801f, 16.5477f, 11.3383f, 16.0107f, 12.001f, 16.0107f)
                curveTo(12.6638f, 16.0107f, 13.201f, 16.5477f, 13.201f, 17.2101f)
                close()
            }
        }
        .build()
...
private var _triangleexclamationfill: ImageVector? = null
