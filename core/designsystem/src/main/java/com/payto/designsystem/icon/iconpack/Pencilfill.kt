...
public val IconPack.Pencilfill: ImageVector
    get() {
        if (_pencilfill != null) {
            return _pencilfill!!
        }
        _pencilfill = Builder(name = "Pencilfill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF343942)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.0142f, 4.3437f)
                curveTo(18.0532f, 4.3046f, 18.1165f, 4.3046f, 18.1556f, 4.3437f)
                lineTo(19.658f, 5.8461f)
                curveTo(19.6971f, 5.8852f, 19.6971f, 5.9485f, 19.658f, 5.9875f)
                lineTo(6.5454f, 19.1002f)
                horizontalLineTo(4.9015f)
                verticalLineTo(17.4563f)
                lineTo(18.0142f, 4.3437f)
                close()
            }
        }
        .build()
