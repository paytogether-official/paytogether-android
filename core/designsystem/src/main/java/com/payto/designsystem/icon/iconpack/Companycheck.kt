...
public val IconPack.Companycheck: ImageVector
    get() {
        if (_companycheck != null) {
            return _companycheck!!
        }
        _companycheck = Builder(name = "Companycheck", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF343942)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(23.838f, 4.0066f)
                lineTo(22.5652f, 2.7338f)
                lineTo(19.6016f, 5.6974f)
                lineTo(18.038f, 4.1338f)
                lineTo(16.7652f, 5.4066f)
            ...
            path(fill = SolidColor(Color(0xFF343942)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.9797f, 2.0999f, 13.3857f, 2.0998f, 13.7188f, 2.1446f)
                ...
                curveTo(20.0909f, 10.1946f, 20.5035f, 10.3149f, 20.8451f, 10.6565f)
                curveTo(21.1866f, 10.998f, 21.3069f, 11.4107f, 21.3569f, 11.7828f)
                curveTo(21.4017f, 12.1158f, 21.4016f, 12.5218f, 21.4016f, 12.9492f)
                lineTo(21.4016f, 21.9f)
                ...
                horizontalLineTo(13.5016f)
                curveTo(13.5568f, 3.8998f, 13.6016f, 3.9446f, 13.6016f, 3.9998f)
                ...
                horizontalLineTo(19.6016f)
                verticalLineTo(11.9998f)
                curveTo(19.6016f, 11.9446f, 19.5568f, 11.8998f, 19.5015f, 11.8998f)
...
private var _companycheck: ImageVector? = null
